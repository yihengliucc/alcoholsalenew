...
import com.alcoholsale.framework.image.IThumbnailCreator;
import com.alcoholsale.framework.image.ImageRuntimeException;
...
public class ImageMagickCreator implements IThumbnailCreator {
	...
	public ImageMagickCreator(String _source, String _target)
		...
		try {
			...
			e.printStackTrace();
			throw new ImageRuntimeException(this.source, "����jmagickutils");
		} finally {
			if (fis != null) {
				fis.close();
			}
