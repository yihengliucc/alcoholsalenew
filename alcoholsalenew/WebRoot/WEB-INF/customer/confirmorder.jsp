				...
				<div class="orderItemsBox orderAddress">
					...
					<div class="itemsWrap">
						<ul class="addressList clearfix">
							<!-- 判断如果该用户没有地址，需要生成一个id='checkAddressId' -->
							<c:if test="${empty addresses }">
							<input id="checkAddressId" type="hidden" name="checkAddressId"
								value="">
							</c:if>
							...
							<c:forEach var="address" items="${addresses }" varStatus="stat">
									...
									<li class="item on" einv="false" onclick="checked(this);"><input
										...
										<div class="address-ope">
											<a class="addAlter" href="javascript:;" _di="107793439">修改</a><a
												class="addDelete" href="javascript:;" onclick="deleteAddress(this);">删除</a>
										</div> <c:if test="${address.isdefault == '1' }">
											<div class="defaultBtn" _di="107793439">默认地址</div>
										</c:if> <c:if test="${address.isdefault != '1' }">
								...
								<c:if test="${!stat.first }">
									<li class="item" einv="false" onclick="checked(this);"><input
										...
										<div class="address-ope">
											<a class="addAlter" href="javascript:;" _di="107793439">修改</a><a
												class="addDelete" href="javascript:;" _di="107793439" onclick="deleteAddress(this);" >删除</a>
										</div>
										<div class="defaultBtn" _di="107793439"
											onclick="setDefault(this)">设为默认地址</div>
										<div class="addDefault oIcon"></div></li>
										...
										<tr>
											<td width="542">
												<div class="productImg">
													<a href="customershowdetail.action" target="_blank"> <img
														src="${pageContext.request.contextPath }/images/product/little_images/${cartProduct.value.product.image}"
														alt="${cartProduct.value.product.proname}" width="52"
														height="52">
													</a>
												</div>
												<div class="productName">
													<p class="oneName">
														<a href="customershowdetail.action" target="_blank"
															title="${cartProduct.value.product.proname}">${cartProduct.value.product.proname}</a>
													</p>
												</div>
											</td>
							...
							<div class="orderTotalFixed" id="orderTotal">
								<div class="orderTotalCon">
									...
									<button rel="_request" data-mask="true" class="action-settle"
										type="submit" id="btn-submit-order">
										<span>提交订单</span>
									</button>
									<div class="toPay">
					...
					<div class="addresPop">
						...
						<div class="addPopCon">
							<ul>
								...
								<li><span class="addTit"><i class="xing">*</i>选择地区：</span>
